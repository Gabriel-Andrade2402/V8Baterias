...
const HomeFooter = () => {
    return (
      <footer className='container-flex position-flex bg-dark mt-5'> 
        <div className='col-12 row py-2 px-4'>
            ...
            <div className='col-sm-12'> 
                <caption className='text-secondary font-size-min'>By Gabriel (gabriel.andrade2402@gmail.com)</caption> 
            </div>
        </div>
      </footer>
   );
